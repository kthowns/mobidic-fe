import 'package:mobidic/global/data/local_db_helper.dart';
...
class WordLocalDataSource implements WordDataSource {
  ...
  Future<List<Word>> getWords(String vocabId) async {
    ...
    for (var wordMap in wordMaps) {
      ...
      final List<Definition> definitions = defMaps
          .map((d) => Definition.fromJsonLocal(d))
          .toList();
      ...
      words.add(
        Word(
          ...
          createdAt: wordMap['created_at'] != null
